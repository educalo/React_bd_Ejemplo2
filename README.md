PROYECTO REACT QUE PERMITE TRABAJAR CON BASE DE DATOS DONDE HAY UNA PARTE BACKEND Y OTRA FRONTEND, PARA INSTALARLA Y VERLA COMO FUNCIONA DEBEMOS SEGUIR LOS SIGUIENTES PASOS:
